...
def test(
    ...
    dataloader = LoadImagesAndLabels(
        test_path, batch_size=batch_size, img_size=img_size)
    ...
    for batch_i, (imgs, targets) in enumerate(dataloader):
        ...
        for sample_i, (labels, detections) in enumerate(zip(targets, output)):
            ...
            print(('%11s%11s' + '%11.3g' * 3) %
                  (len(mAPs), dataloader.nF, mean_P, mean_R, mean_mAP))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='./weightscomplete/yolov3-tiny_best_288.pt', help='path to weights file')
    ...
    parser.add_argument('--img-size', type=int, default=32*9,
