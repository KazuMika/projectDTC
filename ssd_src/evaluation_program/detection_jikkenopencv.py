...
def make_avi(path_to_avi,net, frame_rate,b,count):
    if not os.path.exists("./detection/"+str(b)):
        os.mkdir("./detection/"+str(b))
    ...
    #video = cv2.VideoWriter("./detection/"+str(b) +"/" + path_to_avi, fourcc, frame_rate, (int(cap.get(3)),int(cap.get(4))))
                        ...
                        if i.id==trash_id:
                            ...
                            if i.going_DOWN(line_down) == True:
                                if i.state == True:
                                    ...
                                    cv2.imwrite("./detection/"+ str(b) + "/{0:02d}_".format(count) + path_to_avi + "_{0:04d}.jpg".format(cnt_down),frame)
